    ...
    <div className="p-6 lg:p-8 space-y-6 h-full overflow-y-auto custom-scrollbar">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        <div className="flex gap-3">
          <button 
            ...
            className="px-4 py-2 bg-white/5 hover:bg-white/10 text-zinc-300 rounded-lg text-xs font-medium border border-white/5 transition-colors"
          >
            导出日志
          </button>
          <button 
        ...
        <div className="lg:col-span-1 flex flex-col gap-6 h-96">
            ...
            <BentoCard className="flex-1" title="知识图谱" icon={Globe}>
               <div className="flex items-end justify-between h-full pb-2">
                  <div>
                     <div className="text-4xl font-bold text-white">{summary.total_nodes.toLocaleString()}</div>
            ...
            <BentoCard className="flex-1" title="向量索引" icon={Database}>
                <div className="flex flex-col justify-between h-full pb-2">
                    <div className="flex items-end justify-between">
                      <div>
                         <div className="text-4xl font-bold text-white">{summary.total_documents.toLocaleString()}</div>
        ...
        <BentoCard className="lg:col-span-3 h-[400px]" title="实时安全监测" icon={Activity}>
           <div className="overflow-y-auto pr-2 custom-scrollbar -mr-2 h-full">
             <table className="w-full text-left border-collapse">
               <thead className="text-[10px] uppercase text-zinc-500 font-bold sticky top-0 bg-[#09090b] z-10">
                 <tr>
               ...
               <tbody className="text-xs font-mono">
                 {recentRisks.map((risk) => (
                   <tr key={risk.id} className="border-b border-white/5 hover:bg-white/5 transition-colors group">
                     ...
                     <td className="py-4 text-zinc-300 font-sans font-medium">{risk.title}</td>
                     <td className="py-4">
                     ...
                     <td className="py-4 pr-2 text-right">
                      <button 
                        ...
                        className="text-zinc-500 hover:text-white p-2 hover:bg-white/10 rounded-lg transition-colors group-hover:text-violet-400"
                      >
                        <ArrowRight size={16} />
                      </button>
                    </td>
     ...
     {selectedRisk && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl w-full max-w-2xl shadow-2xl relative overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 border-b border-white/5 flex justify-between items-start bg-zinc-900/50">
              <div className="flex gap-4">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    <span className="font-mono text-xs text-zinc-500 bg-white/5 px-2 py-0.5 rounded">{selectedRisk.id}</span>
                    ...
                    <span className="text-xs font-bold px-2 py-0.5 rounded border border-white/10 text-zinc-400 bg-white/5">
                      {selectedRisk.status}
                    </span>
                  </div>
              ...
              <button 
                ...
                className="text-zinc-500 hover:text-white transition-colors p-2 hover:bg-white/10 rounded-lg"
              >
                <X size={20} />
              </button>
            </div>
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar space-y-6">
              ...
              <div>
                ...
                <div className="bg-white/5 rounded-xl p-4 text-zinc-300 text-sm leading-relaxed border border-white/5">
              ...
              <div>
                ...
                <div className="relative">
                    <textarea 
                        ...
                        className="w-full h-40 bg-black/40 border border-white/10 rounded-xl p-4 text-sm text-zinc-300 focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/50 outline-none resize-none custom-scrollbar leading-relaxed"
                    />
                    ...
                    <div className="absolute bottom-3 right-3 flex gap-2">
                        ...
                        <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 rounded-lg text-xs font-bold border border-white/10 transition-all disabled:opacity-50"
                        >
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button 
                  ...
                  className="flex-1 bg-white/5 hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed text-white py-2.5 rounded-lg font-medium text-sm transition-colors border border-white/10 flex items-center justify-center"
                >
     ...
     {/* Audit Progress Modal */}
      {(auditState.status === 'running' || auditState.status === 'completed' || auditState.status === 'error') && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 w-full max-w-lg shadow-2xl relative overflow-hidden">
            ...
            <div className="w-full bg-zinc-800 h-2 rounded-full mb-6 overflow-hidden relative z-10">
              <div 
            ...
            {/* Logs Window */}
            <div className="h-48 overflow-y-auto bg-black/40 rounded-lg p-4 font-mono text-xs text-zinc-400 custom-scrollbar border border-zinc-800/50 relative z-10">
